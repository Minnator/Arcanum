...
public class ProjectFileDescriptorTests
{
    ...
    {
        var desc = new ProjectFileDescriptor("TestMod");
    ...
    public void Constructor_WithRequiredMods_InitializesCorrectly()
    {
        ...
        var desc = new ProjectFileDescriptor("MainMod", true, mods);
    ...
    {
        var desc = new ProjectFileDescriptor("Test");
    ...
    {
        var a = new ProjectFileDescriptor("X", false, ["A", "B"]);
        var b = new ProjectFileDescriptor("X", false, ["A", "B"]);
    ...
    {
        var a = new ProjectFileDescriptor("X", false, ["A"]);
        var b = new ProjectFileDescriptor("X", true, ["A"]);
