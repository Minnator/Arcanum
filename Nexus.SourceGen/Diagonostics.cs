...
{
    public static readonly DiagnosticDescriptor RedundantIgnoreAttributeWarning = new DiagnosticDescriptor(
        id: "PM001",
    ...
    public static readonly DiagnosticDescriptor RedundantAddAttributeWarning = new DiagnosticDescriptor(
        id: "PM002",
